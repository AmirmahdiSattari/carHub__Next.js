...
import { randomPic } from '@/constants'

const CarDetails = ({ car, isOpen, closeModal , img}) => {
                                    ...
                                    {/* bg-pattern */}
                                        <div className='relative w-full h-40 
                                         bg-cover bg-center rounded-lg'>
                                            <Image src={img} alt="car model" fill
                                                priority className="object-contain bg-blend-exclusion" />
                                        </div>
